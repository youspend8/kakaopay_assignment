...
public abstract class BaseService {
     ...
     * @throws MalformedRequest - X-USER-ID 값이 존재하지 않을경우 발생
     */
    protected String getRequestUserId() throws MalformedRequest {
        return Optional.ofNullable(request.getHeader("X-USER-ID"))
                .orElseThrow(MalformedRequest::new);
    }
     ...
     * @throws MalformedRequest - X-USER-ID 값이 존재하지 않을경우 발생
     */
    protected String getRequestRoomId() throws MalformedRequest {
